...
(function (Drupal, $) {
   ...
   * Define defaults.
   */
  Drupal.behaviors.cookies_twitter = {
    initTwitter: {},

    activate: function (context) {
      var $twttrMedia = $('.media--type-twitter', context);
      $twttrMedia.data('status', 'active').removeClass('disabled');
      if (typeof Drupal.behaviors.cookies_twitter.initTwitter.attach === 'function') {
        Drupal.behaviors.cookies_twitter.initTwitter.attach();
      }
